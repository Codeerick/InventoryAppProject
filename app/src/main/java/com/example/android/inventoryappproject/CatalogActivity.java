...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertInventory() {
        ...
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_SUPPLIER_NAME, getString(R.string.dummy_name));
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_PRICE, getString(R.string.dummy_price));
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_QUANTITY, getString(R.string.dummy_quantity));
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_SUPPLIER_NAME, getString(R.string.dummy_supplier));
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_SUPPLIER_PHONE_NUMBER, getString(R.string.dummy_phone));
