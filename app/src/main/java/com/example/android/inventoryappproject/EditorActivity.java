...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton buttonInc = findViewById(R.id.plus_button);
    ...
    private void saveInventory() {
        ...
        if (!TextUtils.isEmpty(supplierphoneString) && (supplierphoneString.length() != 11)) {
            ...
            values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_SUPPLIER_PHONE_NUMBER, supplierphoneString);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierphoneColumnIndex = cursor.getColumnIndex(InventoryContract.InventoryEntry.COLUMN_INVENTORY_SUPPLIER_PHONE_NUMBER);
