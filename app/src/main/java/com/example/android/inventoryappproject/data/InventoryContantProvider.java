...
public class InventoryContantProvider extends ContentProvider {
     ...
     */
    public static final String LOG_TAG = InventoryContantProvider.class.getSimpleName();
    ...
    static {
        ...
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_WALMART + "/#", INVENTORY_ID);
    }
