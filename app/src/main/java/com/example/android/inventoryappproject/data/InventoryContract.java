...
public class InventoryContract {
    ...
    public static final class InventoryEntry implements BaseColumns {
         ...
         */
        public static final Uri CONTENT_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_WALMART);

        /**
         * The MIME type of the {@link #CONTENT_URI} for a list of inventory items.
         */
        public static final String CONTENT_LIST_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_WALMART;

        /**
         * The MIME type of the {@link #CONTENT_URI} for a single inventory item.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_WALMART;
         ...
         * Type: INTEGER
         */
        public final static String COLUMN_INVENTORY_SUPPLIER_NAME = "sname";

        /**
         * Quantity of produce.
         * Type: INTEGER
         */
        public final static String COLUMN_INVENTORY_SUPPLIER_PHONE_NUMBER =  "phone";
